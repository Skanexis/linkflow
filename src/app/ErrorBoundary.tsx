...
export class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  render() {
    ...
    return (
      <div className="min-h-dvh flex items-center justify-center bg-[#030007] px-6" style={{ fontFamily: "Inter, system-ui, sans-serif" }}>
        <div className="max-w-md text-center">
          ...
          <button
            ...
            style={{ background: "linear-gradient(135deg, #7c3aed, #db2777)", fontSize: "14px", fontWeight: 800 }}
          >
            Reload
          </button>
        </div>
